...
using namespace std;
Quiz_Conduct::Quiz_Conduct()
{
	Topic_Name="";
	Question_Type="";
}
Quiz_Conduct::Quiz_Conduct(string Topic_Name,string Question_Type)
{
	this->Topic_Name=Topic_Name;
	this->Question_Type=Question_Type;
}
void Quiz_Conduct::MCQS_Questions(string course)
{
...
void Quiz_Conduct::True_False_Questions(string course)
{
	if(course=="Programming Fundamentals")
	{
		if(Topic_Name=="Conditional Statements")
...
void Quiz_Conduct::Descriptive_Questions(string course)
{
	if(course=="Programming Fundamentals")
	{
		if(Topic_Name=="Conditional Statements")
